    ...
    <main className="min-h-screen bg-background py-20 px-6">
      <article className="max-w-3xl mx-auto space-y-8">
        ...
        <h1 className="text-4xl font-light text-foreground">
          Website Terms of Use – La Touche
        </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-muted-foreground">
          ...
          <p className="leading-relaxed">
            This website is an early holding page for La Touche. It is provided for general information about our vision and future services. By using this site, you agree to these Terms of Use.
          </p>
          ...
          <ul className="space-y-2 list-disc list-inside">
            <li>Misuse the contact form, for example by sending spam, abusive or unlawful content</li>
          ...
          <p className="leading-relaxed">
            All text, images, branding and other content on this site belong to La Touche or our licensors. You may not copy, reproduce or reuse them without our permission, except for normal personal browsing.
          </p>
          ...
          <p className="leading-relaxed">
            As far as the law allows, we are not liable for any loss or damage arising from use of, or inability to use, this website, or reliance on any content on this website.
          </p>
